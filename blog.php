...
<html lang="en">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
    <div class="container">
      <a class="navbar-brand" href="index.php">Bramavek Hotel</a>
...
<li class="nav-item"><a href="admin/index.php" class="nav-link">Ingresar</a></li>
        </ul>
      </div>
    </div>
  </nav>
      ...
      <div class="row">
        ...
        <div class="col-md-12 mb-4">
          <div class="block-3 d-md-flex">
            <a class="image" href="blog-single.php" style="background-image: url('images/img_3.jpg'); "></a>
            <div class="text">
              ...
              <p><a href="blog-single.php">Read More...</a></p>
            </div>
          </div>  
        </div>
        ...
        <div class="col-md-12 mb-4">
          <div class="block-3 d-md-flex">
            <a class="image" href="blog-single.php" style="background-image: url('images/img_1.jpg'); "></a>
            <div class="text">
        ...
        <div class="col-md-12 mb-4">
          <div class="block-3 d-md-flex">
            <a class="image" href="blog-single.php" style="background-image: url('images/img_7.jpg'); "></a>
            <div class="text">
        ...
        <div class="col-md-12 mb-4">
          <div class="block-3 d-md-flex">
            <a class="image" href="blog-single.php" style="background-image: url('images/img_6.jpg'); "></a>
            <div class="text">
              <h2 class="heading"><a href="#">Our New Presidential Room</a></h2>
              <p class="meta"><em>Posted on</em> <a href="">June 20, 2018</a> <span class="sep">&bullet;</span> <em>by</em> <a href="#">Admin</a> </p>
              <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Tempore, dolorem. Officiis fugit dicta earum, sequi...</p>
        ...
        <div class="col-md-12 mb-4">
          <div class="block-3 d-md-flex">
            <a class="image" href="blog-single.php" style="background-image: url('images/img_5.jpg'); "></a>
            <div class="text">
